/*
New Custom Post Type For Downloads
*/
...
function download_shortcode( $atts ){ 
    ...
    ?>
		<li><a class="caret-left" href="<?php echo $download_link; ?>" target="_blank"><?php echo get_the_title(); ?><i class="fa fa-download"></i></a></li>
    <?php
   		endwhile;
    ?>
	</ul>
    ...
    wp_reset_postdata();
    	...
    	echo '<p class="nofound">No posts found</p>';
  	endif;
  ?>
	
	<!-- <ul class="download-list">
		<li><a class="caret-left" href="/wp-content/uploads/2019/05/Aiport_folder_DUTCH_2.pdf" target="_blank">Brochure voor reizigers<i class="fa fa-download"></i></a></li>
	</ul>
 -->
<?php }
